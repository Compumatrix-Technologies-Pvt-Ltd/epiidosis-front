    ...
    return (
      <div key={index} className="mt-5 flex  ">
        <div className="mt-6 w-auto ">
          ...
          <CardBody>
            <p className="mb-2 text-2xl">{items?.title}</p>
            <Typography>{items?.content}</Typography>
          </CardBody>
          <CardFooter className="pt-0">
            <button className="bg-blue-gray-800 flex items-center gap-2 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">
              Read More{" "}
              <svg
