...
export function Footer() {
  return (
    <footer className="relative w-full  bg-[#0F4767]  text-white      ">
                  ...
                  {items.map((link) => (
                    <li key={link}>
                      <Typography
                        ...
                        href="#"
                        color="gray"
                        className="py-1.5 flex items-center text-white gap-1 font-normal transition-colors hover:text-blue-gray-900"
                      >
                        <svg
