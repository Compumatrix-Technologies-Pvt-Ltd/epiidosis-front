...
function Herosection() {
  return (
    <div className="relative w-full max-h-auto sm:min-h-[55rem] 2xl:min-h-[55rem]">
      <div className="relative bg-gradient-to-tr from-gray-900 to-blue-gray-600 h-full w-full">
        ...
        <div className="absolute p-2 gap-5 md:p-[5rem] top-1/4 flex md:top-1/2 md:-translate-y-1/2 text-white md:w-full">
          ...
          <div className="w-fit md:w-[55rem] md:ml-5  flex flex-col justify-center ">
            <p className="text-xl text-start md:text-[68px] font-inria font-bold  md:leading-[4.5rem] animate-slidein [--slidein-delay:300ms] opacity-0">
      ...
      <div className="md:absolute w-full  flex  justify-center items-center md:h-[35%] h-[30%]">
        <div className=" flex flex-col   md:flex-row gap-5 p-5">
          <div className="relative md:max-w-[20rem] md:justify-center overflow-hidden border shadow-2xl bg-white z-10">
            <CardHeader
              floated={false}
              shadow={false}
              color="transparent"
            ...
            <CardBody>
              <p className="text-2xl font-inria font-bold mb-2 text-center">
                Professional advice
              </p>
              <p className="font-inter md:text-md font-light">
                Lorem ipsum dolor sit amet consectetur. Vel quam sapien diam sed
          ...
          <div className=" relative md:max-w-[20rem]  overflow-hidden border shadow-2xl bg-white z-10">
            <CardHeader
              ...
              className="mx-auto rounded-none bg-yellow-100 w-[10rem] h-[10rem] flex justify-center items-center"
            >
              <img alt="logos" src={userwings} className="mt-5" />
            </CardHeader>
            <CardBody>
              <p className="text-2xl  mb-2 font-inria font-bold text-center">
                Fully independent
              </p>
              <p className="font-inter md:text-md font-light ">
                Lorem ipsum dolor sit amet consectetur. Vel quam sapien diam sed
          ...
          <div className=" relative md:max-w-[20rem]  overflow-hidden border shadow-2xl bg-white z-10">
            ...
            <CardBody>
              <p className="text-2xl mb-2 font-inria font-bold text-center">Transparant</p>
              <p className="font-inter md:text-md font-light">
                Lorem ipsum dolor sit amet consectetur. Vel quam sapien diam sed
                egestas mattis. Pulvinar leo vitae lacus in quis.
              </p>
