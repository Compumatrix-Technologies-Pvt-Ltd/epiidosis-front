    ...
    <div className="bg-bgcream">
      <div className="container   mx-auto flex flex-col items-center justify-center w-full p-5 ">
        <div className="flex justify-center flex-col">
          <p className="text-xl md:text-4xl uppercase font-semibold text-center w-fit">
            Get A free consultation
          </p>
          <div className="bg-primary h-1 mt-2 justify-start w-[10rem]  "></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 mt-12 justify-items-center ">
          <div>
            ...
            >
              ...
              <span className="ml-5 text-lg">9756545662</span>
            </Typography>
            <Typography
              variant="small"
              className="mb-4 mt-5 text-center flex items-center font-normal text-blue-gray-900 md:mb-0"
            >
              ...
              <span className="ml-5 text-lg text-start">
